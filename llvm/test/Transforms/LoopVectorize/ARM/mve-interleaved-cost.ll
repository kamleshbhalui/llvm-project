...
; VF_4:  Cost of 4 for VF 4: WIDEN ir<%tmp2> = load ir<%tmp0>
; VF_4:  Cost of 4 for VF 4: WIDEN store ir<%tmp0>, ir<%tmp2>
; VF_4:  Cost of 4 for VF 4: WIDEN ir<%tmp2> = load ir<%tmp0>
; VF_4:  Cost of 4 for VF 4: WIDEN store ir<%tmp0>, ir<%tmp2>
;
...
; VF_2:  Cost of 2 for VF 2: WIDEN ir<%tmp2> = load ir<%tmp0>
; VF_2:  Cost of 2 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp2>
; VF_2:  Cost of 2 for VF 2: WIDEN ir<%tmp2> = load ir<%tmp0>
; VF_2:  Cost of 2 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp2>
;
...
; VF_4:  Cost of 4 for VF 4: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_4:  Cost of 4 for VF 4: WIDEN store ir<%tmp0>, ir<%tmp3>
; VF_4:  Cost of 4 for VF 4: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_4:  Cost of 4 for VF 4: WIDEN store ir<%tmp0>, ir<%tmp3>
;
; VF_8-LABEL: 'f16_factor_3'
; VF_8:  Cost of 8 for VF 8: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_8:  Cost of 8 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp3>
; VF_8:  Cost of 8 for VF 8: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_8:  Cost of 8 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp3>
;
; VF_16-LABEL: 'f16_factor_3'
; VF_16:  Cost of 16 for VF 16: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_16:  Cost of 16 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp3>
; VF_16:  Cost of 16 for VF 16: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_16:  Cost of 16 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp3>
;
entry:
...
; VF_2:  Cost of 4 for VF 2: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_2:  Cost of 4 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp3>
; VF_2:  Cost of 4 for VF 2: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_2:  Cost of 4 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp3>
;
...
; VF_8:  Cost of 16 for VF 8: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_8:  Cost of 16 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp3>
; VF_8:  Cost of 16 for VF 8: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_8:  Cost of 16 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp3>
;
; VF_16-LABEL: 'f32_factor_3'
; VF_16:  Cost of 32 for VF 16: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_16:  Cost of 32 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp3>
; VF_16:  Cost of 32 for VF 16: WIDEN ir<%tmp3> = load ir<%tmp0>
; VF_16:  Cost of 32 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp3>
;
entry:
...
; VF_2:  Cost of 2 for VF 2: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_2:  Cost of 2 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp4>
; VF_2:  Cost of 2 for VF 2: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_2:  Cost of 2 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp4>
;
; VF_4-LABEL: 'f16_factor_4'
; VF_4:  Cost of 4 for VF 4: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_4:  Cost of 4 for VF 4: WIDEN store ir<%tmp0>, ir<%tmp4>
; VF_4:  Cost of 4 for VF 4: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_4:  Cost of 4 for VF 4: WIDEN store ir<%tmp0>, ir<%tmp4>
;
; VF_8-LABEL: 'f16_factor_4'
; VF_8:  Cost of 8 for VF 8: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_8:  Cost of 8 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp4>
; VF_8:  Cost of 8 for VF 8: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_8:  Cost of 8 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp4>
;
; VF_16-LABEL: 'f16_factor_4'
; VF_16:  Cost of 16 for VF 16: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_16:  Cost of 16 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp4>
; VF_16:  Cost of 16 for VF 16: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_16:  Cost of 16 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp4>
;
entry:
...
; VF_2:  Cost of 4 for VF 2: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_2:  Cost of 4 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp4>
; VF_2:  Cost of 4 for VF 2: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_2:  Cost of 4 for VF 2: WIDEN store ir<%tmp0>, ir<%tmp4>
;
...
; VF_8:  Cost of 16 for VF 8: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_8:  Cost of 16 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp4>
; VF_8:  Cost of 16 for VF 8: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_8:  Cost of 16 for VF 8: WIDEN store ir<%tmp0>, ir<%tmp4>
;
; VF_16-LABEL: 'f32_factor_4'
; VF_16:  Cost of 32 for VF 16: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_16:  Cost of 32 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp4>
; VF_16:  Cost of 32 for VF 16: WIDEN ir<%tmp4> = load ir<%tmp0>
; VF_16:  Cost of 32 for VF 16: WIDEN store ir<%tmp0>, ir<%tmp4>
;
entry:

...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <32 x double>, ptr [[NEXT_GEP]], align 8, !tbaa [[DOUBLE_TBAA7:![0-9]+]]
; CHECK-NEXT:    [[TMP10:%.*]] = fmul <32 x double> [[WIDE_LOAD]], splat (double 3.276800e+04)
; CHECK-NEXT:    [[TMP11:%.*]] = fptosi <32 x double> [[TMP10]] to <32 x i32>
; CHECK-NEXT:    [[TMP12:%.*]] = call <32 x i32> @llvm.smax.v32i32(<32 x i32> [[TMP11]], <32 x i32> splat (i32 -32768))
; CHECK-NEXT:    [[TMP13:%.*]] = call <32 x i32> @llvm.smin.v32i32(<32 x i32> [[TMP12]], <32 x i32> splat (i32 32767))
; CHECK-NEXT:    [[TMP14:%.*]] = trunc nsw <32 x i32> [[TMP13]] to <32 x i16>
; CHECK-NEXT:    store <32 x i16> [[TMP14]], ptr [[NEXT_GEP1]], align 2, !tbaa [[SHORT_TBAA9:![0-9]+]]

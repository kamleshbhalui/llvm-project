...
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <16 x i16> [[TMP0]], i64 0
...
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <8 x i16> [[TMP7]], i64 0
...
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <16 x i16> [[TMP0]], i64 0
...
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <8 x i16> [[TMP8]], i64 0

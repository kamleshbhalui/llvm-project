...
; CHECK-NEXT:    ret
  ...
  call void @def(ptr %alloc)
  %load = load <4 x i8>, ptr %alloc
  %strided.vec = call {<2 x i8>, <2 x i8>} @llvm.vector.deinterleave2.v4i8(<4 x i8>%load)
  %strided.vec0 = extractvalue {<2 x i8>, <2 x i8>}%strided.vec, 0
  store <2 x i8> %strided.vec0, ptr %st_ptr
  ret void
}
...
define void @alloc_v6i8_intrinsic(ptr %st_ptr) nounwind {
; CHECK-LABEL: alloc_v6i8_intrinsic:
; CHECK:       // %bb.0:
; CHECK-NEXT:    sub sp, sp, #32
; CHECK-NEXT:    stp x30, x19, [sp, #16] // 16-byte Folded Spill
; CHECK-NEXT:    mov x19, x0
...
; CHECK-NEXT:    ret
  ...
  call void @def(ptr %alloc)
  %load = load <6 x i8>, ptr %alloc
  %strided.vec = call {<3 x i8>, <3 x i8>} @llvm.vector.deinterleave2.v6i8(<6 x i8>%load)
  %strided.vec0 = extractvalue {<3 x i8>, <3 x i8>}%strided.vec, 1
  store <3 x i8> %strided.vec0, ptr %st_ptr
  ret void
}
...
define void @alloc_v32i8_intrinsic(ptr %st_ptr) nounwind {
; CHECK-LABEL: alloc_v32i8_intrinsic:
; CHECK:       // %bb.0:
; CHECK-NEXT:    sub sp, sp, #48
; CHECK-NEXT:    stp x30, x19, [sp, #32] // 16-byte Folded Spill
; CHECK-NEXT:    mov x19, x0
...
; CHECK-NEXT:    ret
  ...
  call void @def(ptr %alloc)
  %load = load <32 x i8>, ptr %alloc
  %strided.vec = call {<16 x i8>, <16 x i8>} @llvm.vector.deinterleave2.v32i8(<32 x i8>%load)
  %strided.vec0 = extractvalue {<16 x i8>, <16 x i8>}%strided.vec, 0
  %vec9 = shufflevector <16 x i8> %strided.vec0,
                     <16 x i8> poison,
                     <9 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8>
  store <9 x i8> %vec9, ptr %st_ptr
  ret void
}
...
; CHECK-NEXT:    ret
  ...
  call void @def(ptr %alloc)
  %load = load <8 x double>, ptr %alloc
  %strided.vec = call {<4 x double>, <4 x double>} @llvm.vector.deinterleave2.v8f64(<8 x double>%load)
  %strided.vec0 = extractvalue {<4 x double>, <4 x double>}%strided.vec, 1
  store <4 x double> %strided.vec0, ptr %st_ptr
  ret void
}

...
; CHECK-NEXT:    ret
  ...
  %interleaved.vec = call <8 x i32> @llvm.vector.interleave2(<4 x i32> %splat, <4 x i32> %splat)
  store <8 x i32> %interleaved.vec, ptr %a, align 4
  ret void
}
...
; CHECK-NEXT:    ret
 ...
 ; %interleaved = shufflevector <8 x i32> %shuffle, <8 x i32> poison, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
 ; store <8 x i32> %interleaved, ptr %a, align 1
  %interleaved.vec = call <8 x i32> @llvm.vector.interleave2(<4 x i32> %v1, <4 x i32> %v2)
  store <8 x i32> %interleaved.vec, ptr %a, align 1
  ret void
}
...
;  %interleaved.vec = shufflevector <8 x i32> %v1, <8 x i32> %v2, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11,
 ;                                                                            i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  %interleaved.vec = call <16 x i32> @llvm.vector.interleave2(<8 x i32> %v1, <8 x i32> %v2)
  store <16 x i32> %interleaved.vec, ptr %a, align 4
  ret void
}

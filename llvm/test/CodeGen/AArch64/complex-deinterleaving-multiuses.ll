...
; CHECK-NEXT:    ret
entry:
  %a.deinterleaved = tail call { <2 x float>, <2 x float> } @llvm.vector.deinterleave2.v4f32(<4 x float> %a)
  ...
  %b.deinterleaved = tail call { <2 x float>, <2 x float> } @llvm.vector.deinterleave2.v4f32(<4 x float> %b)
  ...
  %5 = fmul fast <2 x float> %strided.vec35, %strided.vec37
  %6 = fadd fast <2 x float> %4, %5
  %otheruse = tail call <4 x float> @llvm.vector.interleave2.v4f32(<2 x float> %2, <2 x float> %6)
  store <4 x float> %otheruse, ptr %p
  %7 = fmul fast <2 x float> %6, %strided.vec
  %8 = fadd fast <2 x float> %3, %7
  %9 = fmul fast <2 x float> %2, %strided.vec
  %10 = fmul fast <2 x float> %6, %strided.vec35
  %11 = fsub fast <2 x float> %9, %10
  %interleaved.vec = tail call <4 x float> @llvm.vector.interleave2.v4f32(<2 x float> %11, <2 x float> %8)
  ret <4 x float> %interleaved.vec
}
...
; Expected to transform partially (only d * c). Shows that external use of the
; interleaved value does not prevent deinterleaving.
;   *p1 = (a * b).real();
;   *p2 = (a * b) * c;
;   return d * c;
...
; CHECK-NEXT:    zip1 v7.2s, v2.2s, v4.2s
; CHECK-NEXT:    zip2 v4.2s, v2.2s, v4.2s
...
entry:
  ...
  %5 = fsub fast <2 x float> %3, %4
  store <2 x float> %5, ptr %p1
  %c.deinterleaved = tail call { <2 x float>, <2 x float> } @llvm.vector.deinterleave2.v4f32(<4 x float> %c)
  ...
  %interleaved.vec = tail call <4 x float> @llvm.vector.interleave2.v4f32(<2 x float> %11, <2 x float> %8)
  store <4 x float> %interleaved.vec, ptr %p2
  %d.deinterleaved = tail call { <2 x float>, <2 x float> } @llvm.vector.deinterleave2.v4f32(<4 x float> %d)
  ...
  %16 = fmul fast <2 x float> %strided.vec97, %strided.vec94
  %17 = fsub fast <2 x float> %15, %16
  %interleaved.vec98 = tail call <4 x float> @llvm.vector.interleave2.v4f32(<2 x float> %17, <2 x float> %14)
  ret <4 x float> %interleaved.vec98
}
...
; CHECK-NEXT:    zip2 v6.2s, v0.2s, v4.2s
; CHECK-NEXT:    zip2 v7.2s, v1.2s, v5.2s
; CHECK-NEXT:    zip2 v19.2s, v2.2s, v16.2s
; CHECK-NEXT:    zip1 v2.2s, v2.2s, v16.2s
; CHECK-NEXT:    zip2 v16.2s, v3.2s, v17.2s
; CHECK-NEXT:    zip1 v0.2s, v0.2s, v4.2s
; CHECK-NEXT:    zip1 v1.2s, v1.2s, v5.2s
; CHECK-NEXT:    zip1 v3.2s, v3.2s, v17.2s
...
; CHECK-NEXT:    fmla v7.2s, v1.2s, v6.2s
; CHECK-NEXT:    fmla v4.2s, v1.2s, v0.2s
; CHECK-NEXT:    fneg v0.2s, v16.2s
; CHECK-NEXT:    fmla v0.2s, v3.2s, v2.2s
; CHECK-NEXT:    fmul v2.2s, v4.2s, v5.2s
; CHECK-NEXT:    fmul v3.2s, v7.2s, v5.2s
; CHECK-NEXT:    str d4, [x0]
; CHECK-NEXT:    fmla v2.2s, v0.2s, v7.2s
; CHECK-NEXT:    fneg v1.2s, v3.2s
; CHECK-NEXT:    fmla v1.2s, v0.2s, v4.2s
; CHECK-NEXT:    mov v0.d[1], v5.d[0]
...
entry:
  ...
  %16 = fmul nnan ninf contract <2 x float> %2, %8
  %17 = fsub nnan ninf contract <2 x float> %15, %16
  %interleaved.vec = tail call <4 x float> @llvm.vector.interleave2.v4f32(<2 x float> %17, <2 x float> %14)
  store <4 x float> %interleaved.vec, ptr %p2
  %interleaved.vec136 = tail call <4 x float> @llvm.vector.interleave2.v4f32(<2 x float> %11, <2 x float> %8)
  ret <4 x float> %interleaved.vec136
}
...
; CHECK-NEXT:    ret
entry:
  %a.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %a)
  ...
  %b.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %b)
  ...
  %2 = fmul fast <2 x double> %strided.vec125, %strided.vec123
  %3 = fadd fast <2 x double> %1, %2
  %c.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %c)
  ...
  %d.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %d)
  ...
  %7 = fmul fast <2 x double> %strided.vec131, %strided.vec129
  %8 = fsub fast <2 x double> %4, %5
  %g.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %g)
  ...
  %h.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %h)
  ...
  %20 = fsub fast <2 x double> %0, %19
  %21 = fsub fast <2 x double> %3, %17
  %interleaved.vec = tail call <4 x double> @llvm.vector.interleave2.v4f64(<2 x double> %20, <2 x double> %21)
  store <4 x double> %interleaved.vec, ptr %p1, align 8
  %e.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %e)
  ...
  %f.deinterleaved = tail call { <2 x double>, <2 x double> } @llvm.vector.deinterleave2.v4f64(<4 x double> %f)
  ...
  %28 = fadd fast <2 x double> %24, %17
  %29 = fadd fast <2 x double> %28, %23
  %interleaved.vec145 = tail call <4 x double> @llvm.vector.interleave2.v4f64(<2 x double> %27, <2 x double> %29)
  store <4 x double> %interleaved.vec145, ptr %p2, align 8
  ret void
}

...
; CHECK-NEXT:    adrp x10, .LCPI45_3
; CHECK-NEXT:    ldr q2, [x10, :lo12:.LCPI45_3]
; CHECK-NEXT:    mov v7.d[1], v5.d[0]
; CHECK-NEXT:    mov v6.d[1], v1.d[0]
; CHECK-NEXT:    ldr q1, [x9, :lo12:.LCPI45_1]
; CHECK-NEXT:    adrp x9, .LCPI45_2
; CHECK-NEXT:    tbl v0.16b, { v6.16b, v7.16b }, v0.16b
; CHECK-NEXT:    tbl v2.16b, { v6.16b, v7.16b }, v2.16b
; CHECK-NEXT:    mov v0.h[3], v4.h[3]
; CHECK-NEXT:    tbl v3.16b, { v6.16b, v7.16b }, v1.16b
; CHECK-NEXT:    ldr q1, [x9, :lo12:.LCPI45_2]
...
; CHECK-NEXT:    adrp x10, .LCPI46_6
; CHECK-NEXT:    fmov d18, d4
; CHECK-NEXT:    fmov d17, d2
; CHECK-NEXT:    fmov d16, d0
; CHECK-NEXT:    ldr q0, [x9, :lo12:.LCPI46_0]
; CHECK-NEXT:    adrp x9, .LCPI46_1
; CHECK-NEXT:    mov v17.d[1], v3.d[0]
; CHECK-NEXT:    ldr q3, [x10, :lo12:.LCPI46_6]
; CHECK-NEXT:    adrp x10, .LCPI46_9
; CHECK-NEXT:    mov v16.d[1], v1.d[0]
; CHECK-NEXT:    ldr q1, [x9, :lo12:.LCPI46_1]
; CHECK-NEXT:    adrp x9, .LCPI46_5
; CHECK-NEXT:    ldr q2, [x9, :lo12:.LCPI46_5]
; CHECK-NEXT:    adrp x9, .LCPI46_2
; CHECK-NEXT:    ldr q4, [x9, :lo12:.LCPI46_2]
; CHECK-NEXT:    adrp x9, .LCPI46_7
; CHECK-NEXT:    tbl v0.16b, { v16.16b, v17.16b }, v0.16b
; CHECK-NEXT:    mov v18.d[1], v5.d[0]
; CHECK-NEXT:    tbl v2.16b, { v16.16b, v17.16b }, v2.16b
; CHECK-NEXT:    tbl v1.16b, { v18.16b, v19.16b }, v1.16b
; CHECK-NEXT:    tbl v3.16b, { v18.16b, v19.16b }, v3.16b
; CHECK-NEXT:    bsl v4.16b, v0.16b, v1.16b
; CHECK-NEXT:    ldr q0, [x9, :lo12:.LCPI46_7]
; CHECK-NEXT:    adrp x9, .LCPI46_3
; CHECK-NEXT:    ldr q1, [x9, :lo12:.LCPI46_3]
; CHECK-NEXT:    adrp x9, .LCPI46_8
; CHECK-NEXT:    bsl v0.16b, v2.16b, v3.16b
; CHECK-NEXT:    ldr q3, [x9, :lo12:.LCPI46_8]
; CHECK-NEXT:    adrp x9, .LCPI46_10
; CHECK-NEXT:    ldr q7, [x9, :lo12:.LCPI46_10]
; CHECK-NEXT:    adrp x9, .LCPI46_4
; CHECK-NEXT:    mov d5, v4.d[1]
; CHECK-NEXT:    tbl v3.16b, { v16.16b, v17.16b }, v3.16b
; CHECK-NEXT:    tbl v6.16b, { v17.16b, v18.16b }, v1.16b
; CHECK-NEXT:    ldr q1, [x10, :lo12:.LCPI46_9]
; CHECK-NEXT:    mov d0, v0.d[1]
; CHECK-NEXT:    tbl v1.16b, { v18.16b, v19.16b }, v1.16b
; CHECK-NEXT:    mov v6.h[3], v19.h[3]
; CHECK-NEXT:    ldr q16, [x9, :lo12:.LCPI46_4]
; CHECK-NEXT:    mov v2.d[1], v0.d[0]
; CHECK-NEXT:    mov v0.16b, v7.16b
; CHECK-NEXT:    bsl v0.16b, v3.16b, v1.16b
; CHECK-NEXT:    tbl v1.16b, { v4.16b, v5.16b, v6.16b }, v16.16b

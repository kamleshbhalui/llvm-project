...
; ZVZIP-NEXT:    vmerge.vim v9, v10, 1, v0
; ZVZIP-NEXT:    vmv.v.v v10, v8
; ZVZIP-NEXT:    vmv.v.v v11, v9
; ZVZIP-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; ZVZIP-NEXT:    vzip.vv v8, v11, v10
; ZVZIP-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; ZVZIP-NEXT:    vmsne.vi v9, v9, 0
...
; CHECK-NEXT:    vadd.vx v12, v12, a0, v0.t
...
; ZVBB:       # %bb.0:
; ZVBB-NEXT:    vsetvli a0, zero, e16, mf2, ta, mu
; ZVBB-NEXT:    vid.v v10
; ZVBB-NEXT:    vand.vi v11, v10, 1
; ZVBB-NEXT:    vmsne.vi v0, v11, 0
; ZVBB-NEXT:    vsrl.vi v12, v10, 1
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    srli a0, a0, 3
; ZVBB-NEXT:    vadd.vx v12, v12, a0, v0.t
; ZVBB-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; ZVBB-NEXT:    vrgatherei16.vv v10, v8, v12
; ZVBB-NEXT:    vmv1r.v v8, v11
; ZVBB-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; ZVBB-NEXT:    vslideup.vi v10, v8, 2
...
; ZVZIP-NEXT:    vslideup.vi v10, v8, 2
...
; ZVBB-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; ZVBB-NEXT:    vslidedown.vx v8, v10, a0
; ZVBB-NEXT:    vslideup.vi v10, v8, 4
; ZVBB-NEXT:    vmv.v.v v8, v10
; ZVBB-NEXT:    ret
;
...
; ZVZIP-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; ZVZIP-NEXT:    vslidedown.vx v8, v10, a0
; ZVZIP-NEXT:    vslideup.vi v10, v8, 4
